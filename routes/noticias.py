...
def nova_noticia(matricula: str):
    try:
        ...
        news = Aviso(data['titulo'], data['subtitulo'],
                     data['texto'], data['data'], data['imagens'])
        ...
        resultado = inserir(MURAL, (news.titulo, news.subtitulo,
                            news.texto, news.data, imagem_bin, news.imagens))
